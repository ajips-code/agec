                                                ...
                                                <tr class="tr-shadow editrow" id="<?php echo $row['id_pk']; ?>">
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            ...
                                                            <button class="item editemp" data-toggle="modal" data-target="#editemployee" data-placement="top" title="edit" data-original-title="Edit"><i class="zmdi zmdi-edit"></i>
                                                            </button>
                                ...
                                <div class="copyright">
                                    <p>
                                        <small class="block">
                                            ...
                                            </script> All rights reserved to OHES| Developed By <i class="fas fa-heart"></i> by <a href="#" target="_blank">Refath</a>
                                        </small>
                                        <br>
                                    </p>
                                </div>
