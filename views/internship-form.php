...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['student-doc']) && $_FILES['student-doc']['error'] == UPLOAD_ERR_OK) {
        ...
        if (!move_uploaded_file($_FILES['student-doc']['tmp_name'], $student_doc_path)) {
            die("Failed to upload student document.");
        }
    }
    ...
    $sql = "INSERT INTO form_internship (country, industry, qualification, first_name, sure_name, student_number, email, phone, message, student_doc_path, resume_path, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
    $stmt = $conn->prepare($sql);
    if (!$stmt) {
        die("Prepare failed: " . $conn->error);
    }
    $stmt->bind_param("sssssssssss", $country, $industry, $qualification, $first_name, $sure_name, $student_number, $email, $phone, $message, $student_doc_path, $resume_path);

    // Print the SQL statement and bound values for debugging
    echo "Executing query: $sql\n";
    echo "With values: $country, $industry, $qualification, $first_name, $sure_name, $student_number, $email, $phone, $message, $student_doc_path, $resume_path";

    if (!$stmt->execute()) {
        // Print error message if the execution fails
    ...
    header("Refresh: 3; URL=internship.php"); // Redirect after 3 seconds
    exit();
}
?>
...
<body>
    <div class="container">
        <div class="logo">
            ...
            <h2>Gain International Experience with Our Internship Programs</h2>
            <h3>Leverage your skills and gain valuable international work experience. Apply now and start your journey.</h3>
        </div>
                    ...
                    <div class="form-container">
                        <div class="form-column">
                            <div class="student-row">
                             ...
                             <input type="text" id="student-number-input" name="student-number" placeholder="Your Student Number" required> 
            ...
            <div class="form-step" id="form-step-4">
                <div class="form-content">
                    <div class="file-upload-row">
                        <label for="student-doc">Upload Proof of Student Number (optional):</label>
                    ...
                    <div class="warning" id="warningMessage4">If have, Please upload the required documents.</div>
                </div>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            submitBtn.addEventListener('click', function(e) {
                if (currentStep === steps.length - 1 && validateStep4()) {
                    ...
                    formData.append('student-number', document.getElementById('student-number-input').value);
