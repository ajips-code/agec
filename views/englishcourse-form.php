...
<body>
            ...
            <div class="container-form">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($fullname) || empty($email) || empty($phone) || empty($message)) {
                        ...
                        $sql = "INSERT INTO form_englishcourse (fullname, email, phone, message) VALUES (?, ?, ?, ?)";
                ...
                <div class="form-container">
                    <div class="form-column">
                        <form id="step5-form" method="POST" action="englishcourse-form.php">
    ...
    <script>
        ...
        form.addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'englishcourse-form.php', true);
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    // Redirect ke halaman englishcourse.php setelah 3 detik
                    setTimeout(function() {
                        window.location.href = 'englishcourse.php';
                    }, 3000);
                } else {
