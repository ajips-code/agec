...
<body>
            ...
            <div class="upper-menu">
                <div class="container-upper">
                    <div class="row justify-content-between">
                        <div class="contact-icons-con col-lg-6 col-md-6 col-sm-12 text-left">
                            <ul class="contact-icons">
                                <a href="tel:+61420402142" style="color: #0A3F7F;">
                                    <li>
                                        <i class="fas fa-phone-alt"></i> +61 420402142 &nbsp;&nbsp;
                                    </li>
                                </a>
                                <a href="tel:+6582104963" style="color: #0A3F7F;">
                                    <li>
                                        <i class="fas fa-phone-alt"></i> +65 82104963 &nbsp;&nbsp;
                                    </li>
                                </a>
                                <a href="mailto:info@agec.com" style="color: #0A3F7F; text-decoration:none;">
                                    <li>
                                        <i class="far fa-envelope-open"></i> info@agec.com
                                    </li>
                                </a>
                            </ul>
                        </div>
                        <div class="social-icons-con col-lg-6 col-md-6 col-sm-12 justify-content-between text-right">
                            <ul class="social-icons">
                                <a href="https://www.facebook.com/profile.php?id=61550526716854" style="color:#3b5998; font-size:17px">
                                    <li style="margin-right: 10px;"> <!-- Memberikan jarak kanan 10px -->
                                        <i class="fab fa-facebook-square"></i>
                                    </li>
                                </a>
                                <a href="https://www.linkedin.com/company/bigbreak-immigration" style="color:#0077B5; font-size:18px">
                                    <li style="margin-right: 10px;"> <!-- Memberikan jarak kanan 10px -->
                                        <i class="icon-linkedin"></i>
                                    </li>
                                </a>
                                <a href="https://www.youtube.com/@HABIBIEGLOBAL" style="color:#FF0000; font-size:17px">
                                    <li> <!-- Tidak ada margin di kanan untuk ikon terakhir -->
                    ...
                    <ul class="services-header col-lg-12 col-sm-12 mt-4 text-center">
                        <a href="rpl_certification.php" style="font-size: 12px; color:#999999;">
                            <li>RPL CERTIFICATION &nbsp;&nbsp;|&nbsp;&nbsp; </li>
                        </a>
                        <a href="internship.php" style="font-size: 12px; color:#999999;">
                            <li>INTERNSHIP &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="jobs.php" style="font-size: 12px; color:#999999;">
                            <li>JOBS &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="tourist_visa.php" style="font-size: 12px; color:#999999;">
                            <li>TOURIST VISA &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="working_holiday_visa.php" style="font-size: 12px; color:#999999;">
                            <li>WORKING HOLIDAY VISA &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="business_visa.php" style="font-size: 12px; color:#999999;">
                            <li>BUSINESS VISA &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="pr_assessment.php" style="font-size: 12px; color:#999999;">
                            <li>PR ASSESSMENT &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="elicos.php" style="font-size: 12px; color:#999999;">
                            <li>ELICOS &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="englishcourse.php" style="font-size: 12px; color:#999999;">
                            <li>ENGLISH COURSES &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="germany_programme.php" style="font-size: 12px; color:#999999;">
                            <li>GERMANY PROGRAMME &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="courses.php" style="font-size: 12px; color:#999999;">
                            <li>COURSES &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="builders_licence.php" style="font-size: 12px; color:#999999;">
                            <li>BUILDERS LICENCE &nbsp;&nbsp;|&nbsp;&nbsp;</li>
                        </a>
                        <a href="trade_licensing.php" style="font-size: 12px; color:#999999;">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-md-offset-3">
                    <div class="text-center r-inner-banner">
                        <h1 style="font-family: 'Open Sans', Sans-serif;font-size: 36px; font-weight: 700; color:#0077B5">English Courses</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="main-content">
        ...
        <div class="intro">
            ...
            <a href="englishcourse-form.php" class="cta-button">Take the FREE 60 second skills check now!!</a>
            <div class="image-section">
                <img src="../../australianglobalconsultancy-master/images/manbhir-removebg-preview.png" alt="Manbhir Singh" class="person-image">
                <div class="caption">Manbhir Singh<br>Australian Global Education Consultancy Ambassador</div>
            </div>
        </div>
    </main>
    ...
    <div class="skills-container">
        ...
        <div class="skills-content-section">
            ...
            <div class="skills-buttons">
                ...
                <a href="#">View Qualifications</a>
            </div>
        </div>
    </div>

    <div id="colorlib-contact" style="margin-top: 60px;">
        <div class="container">
            <div class="row">
            ...
            <div class="row row-pb-md">
                ...
                <div class="col-md-3 colorlib-widget text-center">
                    ...
                    <ul class="colorlib-footer-links">
                        ...
                        <li><a href="contact.html"><i class="far fa-check-circle"></i> Contact Us</a></li>
                    </ul>
                    </p>
                </div>
                ...
                <div class="col-md-3 colorlib-widget text-center">
                    ...
                    <ul class="colorlib-footer-links">
                        ...
                        <li><a href="mailto:info@agec.com"><i class="far fa-envelope-open"></i> info@agec.com</a></li>
