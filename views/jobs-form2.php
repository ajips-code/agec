                            ...
                            <div class="col-md-6 animate-box">
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                    ...
                                    if (empty($fullname) || empty($email) || empty($message) || empty($selectedCountry) || empty($selectedIndustry) || empty($selectedQualification)) {
                                        ...
                                        $sql = "INSERT INTO form2_jobs (fullname, email, message, selectedCountry, selectedIndustry, selectedQualification) VALUES (?, ?, ?, ?, ?, ?)";
                                ...
                                <form method="POST" action="jobs-form2.php" autocomplete="off">
