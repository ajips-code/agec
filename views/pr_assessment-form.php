...
<head>
    ...
    <link rel="stylesheet" href="../css/rpl_assessment-form.css">
...
<body>
    <div class="container">
        <div class="logo">
            ...
            <h2>Use your work experience to achieve a nationally recognised qualification</h2>
                ...
                <div class="form-container">
                    <div class="form-column">
                        <form id="step5-form" method="POST" action="rpl_certification-form.php">
                            ...
                            <input type="tel" id="usi-number-input" name="usi-number" required>
        ...
        <div class="form-step" id="form-step-6" method="POST" action="rpl_certification-form.php" enctype="multipart/form-data">
            <div class="form-content">
                <label for="id-card">Upload 100 points ID (Passport, Student Card, Drivers License, Utility Bill, Phone Bill, Bank Card, Other photo ID's)</label>
