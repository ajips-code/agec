...
<body>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-md-offset-3">
                    <div class="text-center r-inner-banner">
                        <h1 style="font-family: 'Open Sans', Sans-serif;font-size: 36px; font-weight: 700; color:#0077B5">Builders Licence</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="main-content">
        ...
        <div class="intro">
            ...
            <a href="builders_licence-form.php" class="cta-button">Take the FREE 60 second skills check now!!</a>
