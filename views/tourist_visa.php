...
<body>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-md-offset-3">
                    <div class="text-center r-inner-banner">
                        <h1 style="font-family: 'Montserrat', Sans-serif;font-size: 36px; font-weight: 400; color:#0077B5">Tourist Visa</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="main-content">
        ...
        <div class="intro">
            ...
            <a href="tourist_visa-form.php" class="cta-button">Take the FREE 60 second skills check now!!</a>
