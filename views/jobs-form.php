...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $student_doc_path = handle_upload('student-doc');
    $resume_path = handle_upload('resume');

    // Check for duplicate entry
    $check_sql = "SELECT * FROM form_job WHERE email = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO form_job (country, industry, qualification, first_name, last_name, email, country_code, phone, message, student_doc_path, resume_path, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssssssssss", $country, $industry, $qualification, $first_name, $last_name, $email, $country_code, $phone, $message, $student_doc_path, $resume_path);
    ...
    // Redirect back to jobs.php after a delay
    header("Refresh: 3; URL=jobs.php"); // Redirect after 3 seconds
    exit();
}
?>
    ...
    <div class="container">
        <div class="logo">
            ...
            <h2 style="font-size:34px;"><b class="bolder-trusted" style="color: #4caf50;">"</b>
                <b class="gold" style=" color:#D1A730; font-family: 'Bell MT'; font-weight:bolder;">Australian <b class="bolder-trusted" style="color: #4caf50;">Trusted</b> Education Consultants</b><b class="bolder-trusted" style="color: #4caf50;">"</b></br>
            </h2>
            <h2>Start your carieer pathway with job opportunities in overseas</h2>
        ...
        <form id="main-form" method="POST" action="jobs-form.php" enctype="multipart/form-data">
            <div class="form-step active" id="form-step-1">
                <div class="form-content">
                    <!-- <label for="countrySelect">Which country is your destination for job?</label> -->
                    <select id="countrySelect" name="country">
                        <option value="">Select your Country Destination</option>
                    ...
                    <select id="nationalitycountrySelect" name="nationality-country">
            ...
            <div class="btn-group">
                ...
                <button type="submit" id="submit" style="display: none; background: #4CAF50; color: white;">Submit</button>
            </div>
        </form>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function validateStep3() {
                ...
                if (firstNameInput.value === "" || lastNameInput.value === "" || emailInput.value === "" || countryCodeSelect.value === "" || phoneNumberInput.value === "" || messageInput.value === "") {
                ...
                localStorage.setItem('country-code', countryCodeSelect.value);
            ...
            submitBtn.addEventListener('click', function() {
                if (currentStep === steps.length - 1 && validateStep4()) {
                    ...
                    formData.append('last-name', localStorage.getItem('last-name'));
                    ...
                    xhr.open('POST', 'jobs-form.php', true);
                    xhr.onload = function() {
                        if (xhr.status === 200) {
            ...
            function qualificationSelectChange() {
                ...
                var qualifications = {
                    ...
                    "Education": [
                        ...
                        "Director of Interprofessional Education & Quality Enhancement Plan",
