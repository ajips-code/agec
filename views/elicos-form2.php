                            ...
                            <ul id="ctopul">
                                ...
                                <li id="serviceindex" class="has-dropdown">
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="englishcourse.php">GERMANY PROGRAMME&nbsp;</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-md-offset-3">
                                <div class="text-center r-inner-banner">
                                    <h1>Elicos Program in Australia</h1>
                                    <h2>SIGN UP NOW !</h2>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 animate-box">
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                    ...
                                    if (empty($fullname) || empty($email) || empty($message) || empty($selectedCountry) || empty($selectedIndustry) || empty($selectedQualification)) {
                                        ...
                                        $sql = "INSERT INTO form2_internship (fullname, email, message, selectedCountry, selectedIndustry, selectedQualification) VALUES (?, ?, ?, ?, ?, ?)";
                                ...
                                <form method="POST" action="internship-form2.php" autocomplete="off">
