...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $check_sql = "SELECT * FROM form_visa_application WHERE email = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO form_visa_application (country, nationality, visaCountry, visaType, fullname, email, phone, message, student_doc_path, resume_path, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
    ...
    header("Refresh: 3; URL=study_visa.php"); // Redirect after 3 seconds
    exit();
}
?>
...
<body>
    <div class="container">
        <div class="logo">
            ...
            <h3>Our agents can help you to get your visa and the opportunities you dream of overseas</h3>
        </div>
        ...
        <form id="main-form" method="POST" action="study_visa-form.php" enctype="multipart/form-data">
            <div class="form-step active" id="form-step-1">
                <div class="form-content">
                    <h3>Which country is your destination for visa?</h3>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            submitBtn.addEventListener('click', function() {
                if (currentStep === steps.length - 1 && validateStep4()) {
                    ...
                    xhr.open('POST', 'study_visa-form.php', true);
                    xhr.onload = function() {
                        if (xhr.status === 200) {
                            showNotification('Submission successful!');
                            setTimeout(function() {
                                window.location.href = 'study_visa.php';
                            }, 4000);
                        } else {
