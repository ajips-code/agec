...
<body>
    ...
    <main class="main-content">
        <h2 style="color:white;font-size: 34px; margin-top: 10px; margin-bottom: 40px; font-family: 'Bell MT', sans-serif;">Get your <b class="bolder-trusted" style="font-weight: 500;">Training Visa</b> with <br><b class="bolder-trusted">"</b><b class="gold" style="color:#D1A730; font-family: 'Bell MT'; font-weight:bolder;">Australian <b class="bolder-trusted">Trusted</b> Education Consultants</b><b class="bolder-trusted">"</b></br> </h2>
        <div class="intro-container">
            <div class="intro" id="intro">
                ...
                <a href="training_visa-form.php" class="cta-button">Take the FREE 60 second training visa check now!!</a>
                <p>The Training Visa (Subclass 407) is a temporary visa that allows individuals to participate in workplace-based occupational training activities in Australia. This visa is designed to enhance skills for your job, area of tertiary study, or field of expertise.</p>
                    ...
                    <div class="timeline1">
                        <div class="timeline-heading">
                            <div class="timeline-highlight">
                                ...
                                <h1 style="color: #0077B5;font-size: 36px;font-weight: 800;line-height: 61px;letter-spacing: 0px;">4 Simple Steps to Success with a Training Visa</h1>
                                <p>Embark on your journey to Australia with ease.</p>
                                <p>Through the Training Visa (Subclass 407) process, you can enhance your skills and career prospects by participating in structured workplace-based training programs in Australia.</p>
                            </div>
                        </div>
                        <div class="timeline-item">
                            <div class="timeline-content">
                                <h3 class="title-higlight">Your Path to Professional Growth Starts Here</h3>
                                <p>Our dedicated consultants will guide you through each step of the training visa application process.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="timeline2">
                        <div class="timeline-item active">
                            <div class="timeline-content">
                                <h3 class="title">Free Initial Consultation</h3>
                                <p>Discuss your goals with us and let us guide you towards the appropriate training program that will help you achieve them.</p>
                            </div>
                        </div>
                        <div class="timeline-item">
                            <div class="timeline-content">
                                <h3 class="title">Submit Your Application</h3>
                                <p>Our consultants will assist you in gathering and submitting all necessary documents for your training visa application.</p>
                            </div>
                        </div>
                        <div class="timeline-item">
                            <div class="timeline-content">
                                <h3 class="title">Await Approval</h3>
                                <p>Once submitted, your application will be reviewed by the relevant authorities. Our team will keep you updated throughout the process.</p>
                            </div>
                        </div>
                        <div class="timeline-item">
                            <div class="timeline-content">
                                <h3 class="title">Start Your Training in Australia</h3>
                                <p>Upon approval, you can start your training program in Australia, enhancing your skills and career prospects.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="floating-whatsapp2" style="bottom: 40px !important;">
    ...
    <footer class="chat-widget">
        <div class="chat-message">Welcome to Australian Global Education Consultancy! How can I assist you today with your Training Visa application?</div>
