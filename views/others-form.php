            ...
            <div class="container-form">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($fullname) || empty($email) || empty($phone) || empty($message)) {
                        ...
                        $sql = "INSERT INTO form_jobs (fullname, email, phone, message) VALUES (?, ?, ?, ?)";
                ...
                <div class="form-container">
                    <div class="form-column">
                        <form id="step5-form" method="POST" action="jobs-form.php">
        ...
        form.addEventListener('submit', function(event) {
            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    // Redirect ke halaman jobs.php setelah 3 detik
                    setTimeout(function() {
