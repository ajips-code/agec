...
<body>
            ...
            <div class="container-form">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($fullname) || empty($email) || empty($phone) || empty($message)) {
                        ...
                        $sql = "INSERT INTO form_builders_licence (fullname, email, phone, message) VALUES (?, ?, ?, ?)";
                ...
                <div class="form-container">
                    <div class="form-column">
                        <form id="step5-form" method="POST" action="builders_licence-form.php">
    ...
    <script>
        ...
        form.addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'builders_licence-form.php', true);
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    // Redirect ke halaman builders_licence.php setelah 3 detik
                    setTimeout(function() {
                        window.location.href = 'builders_licence.php';
                    }, 3000);
                } else {
