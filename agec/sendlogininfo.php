...
<head>
    ...
    <style type="text/css">
        .mailsucs{
            ...
            height: auto;
            width: 300px;
            background-image: url(../images/AGEC-Logo_Full-Colour.png);
...
<?php
    ...
    $myAwardSpaceEmail = "Enroll@australianglobaleducationconsultancy.com";
    $myAwardSpaceEmailPassword = "ageccontact@12";
    $myPersonalEmail = "info@agec.com";
    ...
    require './src/SMTP.php';
     ...
     // if(isset($_POST['submit'])) { 
        ...
        $replymail = "Enroll@australianglobaleducationconsultancy.com";
        $fullname = "Admin";
        $content = "Username:agecadmin,password:agecadmin@12";
...
?>
        <div class = "mailsucs">
            <img src = "images/AGEC-Logo_Full-Colour.png" style = "height:300px;width:300px;"> 
