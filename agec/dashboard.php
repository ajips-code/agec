...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a href="dashboard.php">
                            <img src="images/AGEC-Logo_Full-Colour.png" alt="OHES Admin" style="height: 5em;width: 5em;" /><span>AGEC Admin</span>
                        </a>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="dashboard.php">
                    <img src="images/AGEC-Logo_Full-Colour.png" alt="OHES Admin" style="height: 2.5em;width: 5em;" /><span style="color:black; font-family: Poppins;">&nbsp;&nbsp;&nbsp;AGEC Admin</span>
                </a>
            </div>
                            ...
                            <div class="header-button" style="margin-left: auto;">
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <!-- <img src="images/AGEC-Logo_Full-Colour.png" alt="Ohesadmin" /> -->
                                        </div>
                                        <div class="content">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="text-center">Welcome to the Admin Panel of AGEC</h3>
                                <p class="text-center">From here you can control which content to show in your website</p>
                                <div class="text-center mt-4">
                                    <img style="height: 10em;" src="images/AGEC-Logo_Full-Colour.png" alt="">
                                </div>
                            </div>
